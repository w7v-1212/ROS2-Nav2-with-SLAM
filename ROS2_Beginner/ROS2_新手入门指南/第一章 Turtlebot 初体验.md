# 第一章 Turtlebot3 初体验
## 前言
本章节将带你使用 TurtleBot3 体验 SLAM 建图与 Navigation 导航的完整流程。本章节不涉及任何代码层面的讲解，重点在于帮助你快速理解整体流程，并完成一次完整的实战体验。代码相关的部分将在后续章节中逐步拆解讲解，因此你只需要先按照步骤操作，熟悉整体运行方式即可，看看系统是如何完成 **建图 → 定位 → 导航** 这一整套流程的
...
```
![](https://github.com/w7v-1212/ROS2-Nav2-with-SLAM/blob/main/ROS2_Beginner/ROS2_%E6%96%B0%E6%89%8B%E5%85%A5%E9%97%A8%E6%8C%87%E5%8D%97/Images/%E5%B1%8F%E5%B9%95%E6%88%AA%E5%9B%BE%202026-04-22%20120226.png)
...
做到这一步时，你会看到桌面上弹出了 Gazebo 窗口，同时还会出现一个键盘控制界面。此时只需要使用键盘上的按键进行操作，就可以看到 TurtleBot3 开始在仿真环境中移动了

![](https://github.com/w7v-1212/ROS2-Nav2-with-SLAM/blob/main/ROS2_Beginner/ROS2_%E6%96%B0%E6%89%8B%E5%85%A5%E9%97%A8%E6%8C%87%E5%8D%97/Images/%E5%B1%8F%E5%B9%95%E6%88%AA%E5%9B%BE%202026-04-22%20130308.png)
...
![](https://github.com/w7v-1212/ROS2-Nav2-with-SLAM/blob/main/ROS2_Beginner/ROS2_%E6%96%B0%E6%89%8B%E5%85%A5%E9%97%A8%E6%8C%87%E5%8D%97/Images/%E5%B1%8F%E5%B9%95%E6%88%AA%E5%9B%BE%202026-04-22%20130635.png)

可以发现，上述指令与第二小节中的指令基本一致，只是额外增加了一个建图节点。因此可以得出结论：该指令在运行后，不仅会弹出 **Gazebo 窗口**、**键盘控制界面**，还会同步启动**建图节点和 RViz 可视化**，在机器人运动过程中实时进行地图构建
